...
const ModelingModuleWorking = () => {
  ...
  const loadTestModels = () => {
    ...
    console.log('ModelingModuleWorking: Loading test models');
    ...
    console.log('ModelingModuleWorking: New model data:', newModelData);
    ...
    setModelingData(prev => {
      ...
      console.log('ModelingModuleWorking: Updated modeling data:', updated);
      return updated;
    });
  ...
  return (
    <div className="modeling-module">
      <h2>Рабочий модуль моделирования окклюзионных накладок</h2>
...
export default ModelingModuleWorking;
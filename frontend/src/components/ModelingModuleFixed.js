...
const ModelingModuleFixed = () => {
  ...
  const loadTestModels = () => {
    ...
    console.log('ModelingModuleFixed: Loading test models');
    ...
    console.log('ModelingModuleFixed: New model data:', newModelData);
    ...
    setModelingData(prev => {
      ...
      console.log('ModelingModuleFixed: Updated modeling data:', updated);
      return updated;
    });
  ...
  const exportModel = async (format) => {
    ...
    try {
      ...
      if (exportResponse.success && exportResponse.download_url) {
        ...
        console.log('ModelingModuleFixed create object URL with blob:', blob);
...
export default ModelingModuleFixed;
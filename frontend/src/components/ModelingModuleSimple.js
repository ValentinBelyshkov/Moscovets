...
const ModelingModuleSimple = () => {
  ...
  const loadTestModels = () => {
    ...
    console.log('ModelingModuleSimple: Loading test models');
    ...
    console.log('ModelingModuleSimple: New model data:', newModelData);
    ...
    setModelingData(prev => {
      ...
      console.log('ModelingModuleSimple: Updated modeling data:', updated);
      return updated;
    });
  ...
  return (
    <div className="modeling-module">
      <h2>Простой модуль моделирования окклюзионных накладок</h2>
...
export default ModelingModuleSimple;
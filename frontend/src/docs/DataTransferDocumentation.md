...
В приложении Moskovets 3D реализована система передачи данных между модулями через общий контекст данных. Это позволяет различным частям приложения обмениваться информацией, такой как измерения, файлы пациентов и 3D модели.
